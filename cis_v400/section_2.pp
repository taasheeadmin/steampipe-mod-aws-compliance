...
locals {
  ...
  cis_v400_2_3_common_tags = merge(local.cis_v400_2_common_tags, {
    cis_section_id = "2.3"
  })
}
...
benchmark "cis_v400_2_1" {
  ...
  children = [
    control.cis_v400_2_1_1,
    control.cis_v400_2_1_2,
    control.cis_v400_2_1_3,
    control.cis_v400_2_1_4
  ]
...
benchmark "cis_v400_2_3" {
  ...
  children = [
    control.cis_v400_2_3_1
  ]

  tags = merge(local.cis_v400_2_3_common_tags, {
    service = "AWS/RDS"
    type    = "Benchmark"
  })
}
