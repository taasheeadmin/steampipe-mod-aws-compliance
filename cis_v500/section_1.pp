locals {
  cis_v500_1_common_tags = merge(local.cis_v500_common_tags, {
    cis_section_id = "1"
  })
}
...
benchmark "cis_v500_1" {
  ...
  documentation = file("./cis_v500/docs/cis_v500_1.md")
  children = [
    control.cis_v500_1_1,
    control.cis_v500_1_2,
    control.cis_v500_1_3,
    control.cis_v500_1_4,
    control.cis_v500_1_5,
    control.cis_v500_1_6,
    control.cis_v500_1_7,
    control.cis_v500_1_8,
    control.cis_v500_1_9,
    control.cis_v500_1_10,
    control.cis_v500_1_11,
    control.cis_v500_1_12,
    control.cis_v500_1_13,
    control.cis_v500_1_14,
    control.cis_v500_1_15,
    control.cis_v500_1_16,
    control.cis_v500_1_17,
    control.cis_v500_1_18,
    control.cis_v500_1_19,
    control.cis_v500_1_20,
    control.cis_v500_1_21
  ]
...
control "cis_v500_1_1" {
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_1.md")
  severity      = "critical"
...
control "cis_v500_1_2" {
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_2.md")
  severity      = "critical"
...
control "cis_v500_1_3" {
  title         = "1.3 Ensure no 'root' user account access key exists"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_3.md")
  severity      = "critical"
...
control "cis_v500_1_5" {
  title         = "1.5 Ensure hardware MFA is enabled for the 'root' user account"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_5.md")
  severity      = "critical"
...
control "cis_v500_1_6" {
  title         = "1.6 Eliminate use of the 'root' user for administrative and daily tasks"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_6.md")
  severity      = "critical"
...
control "cis_v500_1_7" {
  title         = "1.7 Ensure IAM password policy requires minimum length of 14 or greater"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_7.md")
  severity      = "critical"
...
control "cis_v500_1_8" {
  title         = "1.8 Ensure IAM password policy prevents password reuse"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_8.md")
  severity      = "critical"
...
control "cis_v500_1_9" {
  title         = "1.9 Ensure multi-factor authentication (MFA) is enabled for all IAM users that have a console password"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_9.md")
  severity      = "critical"
...
control "cis_v500_1_10" {
  title         = "1.10 Do not create access keys during initial setup for IAM users with a console password"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_10.md")
  severity      = "critical"
...
control "cis_v500_1_11" {
  title         = "1.11 Ensure credentials unused for 45 days or more are disabled"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_11.md")
  severity      = "critical"
...
control "cis_v500_1_12" {
  title         = "1.12 Ensure there is only one active access key for any single IAM user"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_12.md")
  severity      = "critical"
...
control "cis_v500_1_13" {
  title         = "1.13 Ensure access keys are rotated every 90 days or less"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_13.md")
  severity      = "critical"
...
control "cis_v500_1_14" {
  title         = "1.14 Ensure IAM Users Receive Permissions Only Through Groups"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_14.md")
  severity      = "critical"
...
control "cis_v500_1_15" {
  title         = "1.15 Ensure IAM policies that allow full \"*:*\" administrative privileges are not attached"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_15.md")
  severity      = "critical"
...
control "cis_v500_1_16" {
  title         = "1.16 Ensure a support role has been created to manage incidents with AWS Support"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_16.md")
  severity      = "critical"
...
control "cis_v500_1_18" {
  title         = "1.18 Ensure that all expired SSL/TLS certificates stored in AWS IAM are removed"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_18.md")
  severity      = "critical"
...
control "cis_v500_1_20" {
  title         = "1.20 Ensure IAM users are managed centrally via identity federation or AWS Organizations for multi-account environments"
  ...
  query         = query.manual_control
  documentation = file("./cis_v500/docs/cis_v500_1_20.md")
  severity      = "critical"
...
control "cis_v500_1_21" {
  title         = "1.21 Ensure access to AWSCloudShellFullAccess is restricted"
  ...
  documentation = file("./cis_v500/docs/cis_v500_1_21.md")
  severity = "high"
