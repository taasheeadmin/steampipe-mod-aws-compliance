...
control "cis_v200_1_13" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_1_13.md")
  severity       = "critical"
...
control "cis_v200_1_18" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_18.md")
  severity       = "critical"
...
control "cis_v200_1_19" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_1_19.md")
  severity       = "critical"
...
control "cis_v200_1_20" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_1_20.md")
  severity       = "critical"
...
control "cis_v200_1_21" {
  ...
  query         = query.manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_21.md")
  severity       = "critical"
