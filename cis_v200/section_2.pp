...
locals {
  cis_v200_2_1_common_tags = merge(local.cis_v200_2_common_tags, {
    cis_section_id = "2.1"
  })
  cis_v200_2_2_common_tags = merge(local.cis_v200_2_common_tags, {
    cis_section_id = "2.2"
  })
  cis_v200_2_3_common_tags = merge(local.cis_v200_2_common_tags, {
    cis_section_id = "2.3"
  })
  cis_v200_2_4_common_tags = merge(local.cis_v200_2_common_tags, {
    cis_section_id = "2.4"
  })
}
...
benchmark "cis_v200_2" {
  ...
  children = [
    ...
    benchmark.cis_v200_2_3,
    benchmark.cis_v200_2_4
  ]
...
control "cis_v200_2_1_3" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_2_1_3.md")
  severity = "manual"
...
control "cis_v200_2_1_4" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_2_1_4.md")
  severity = "automated"
...
benchmark "cis_v200_2_3" {
  ...
  children = [
    control.cis_v200_2_3_1,
    control.cis_v200_2_3_2,
    control.cis_v200_2_3_3
  ]

  tags = merge(local.cis_v200_2_3_common_tags, {
    service = "AWS/RDS"
    type    = "Benchmark"
  })
}
...
control "cis_v200_2_3_1" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_2_3_1.md")
  severity = "critical"
...
control "cis_v200_2_3_2" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_2_3_2.md")
  severity = "critical"
...
control "cis_v200_2_3_3" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_2_3_3.md")
  severity = "critical"
...
benchmark "cis_v200_2_4" {
  ...
  children = [
    control.cis_v200_2_4_1
  ]

  tags = merge(local.cis_v200_2_4_common_tags, {
    service = "AWS/EFS"
    type    = "Benchmark"
  })
}
...
control "cis_v200_2_4_1" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_2_4_1.md")
  severity = "critical"
